...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    CountingIdlingResource idlingResource = new CountingIdlingResource("LOGIN_SERVICE_CALL");
    ...
    /**
     *
     * @return AuthenticationActivity's idling resource for Espresso testing
     */
    public CountingIdlingResource getEspressoIdlingResourceForAuthenticationActivity() {
